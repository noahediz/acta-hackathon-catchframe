...
const DemoAnnouncement = () => {
  return (
    <div className='fixed flex-wrap top-0 left-0 gap-y-0 text-sm w-full bg-blue-500 text-primary-foreground z-10 flex items center gap-2 items-center justify-center text-center' >
